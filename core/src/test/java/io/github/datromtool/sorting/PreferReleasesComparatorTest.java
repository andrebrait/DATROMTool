...
public class PreferReleasesComparatorTest {
    ...
    @Test
    public void testCompare_shouldPreferReleaseOverProto() {
        SubComparator subComparator = new PreferReleasesSubComparator();
        ParsedGame tg1 = ParsedGame.builder()
                .regionData(getRegionByCode(regionData, "USA"))
    ...
    @Test
    public void testCompare_shouldPreferReleaseOverBeta() {
        SubComparator subComparator = new PreferReleasesSubComparator();
        ParsedGame tg1 = ParsedGame.builder()
                .regionData(getRegionByCode(regionData, "USA"))
    ...
    @Test
    public void testCompare_shouldPreferReleaseOverDemo() {
        SubComparator subComparator = new PreferReleasesSubComparator();
        ParsedGame tg1 = ParsedGame.builder()
                .regionData(getRegionByCode(regionData, "USA"))
